...
- Activity summary and monthly cash flow sections
...
- Mixed-currency reports show one row per currency and do not convert or combine unlike currencies

**Monthly cash flow:**
- Month-by-month breakdown
- Mixed-currency reports include currency as an explicit column
